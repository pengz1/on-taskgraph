...
function taskRunnerFactory(
    ...
    TaskRunner.prototype.runTask = function(data) {
        ...
        return Rx.Observable.just(data)
            ...
            .tap(function(task) {
                ...
                self.publishStartedProgress(task);
     ...
     * @memberOf TaskRunner
     */
    TaskRunner.prototype.publishStartedProgress = function(task) {
        ...
        progressData = {
            ...
            progress: {
                percentage: "na",
                msg: 'Task "' + taskFriendlyName + '" started',
            },
            taskProgress: {
                graphId: task.context.graphId,
                taskId: task.instanceId,
        ...
        return taskMessenger.publishProgressEvent(task.context.target, progressData)
        .then(function(){
    ...
    TaskRunner.prototype.publishTaskFinished = function(task) {
        ...
        progressData = {
            ...
            progress: {
                percentage: "na",
                msg: 'Task "' + taskFriendlyName + '" finished',
            },
            taskProgress: {
                graphId: task.context.graphId,
                taskId: task.instanceId,
        ...
        .then(function(){
            ...
            .catch(function(error) {
                logger.error('Error publishing progress event when task finished', {
                    taskId: task.instanceId,
                    graphId: task.context.graphId,
                    error: error
                });
